 ...
 */
public class deposit_hindi extends javax.swing.JFrame {

    /**
     * Creates new form splash
     */
    public deposit_hindi() {
        initComponents();
        seticon();
...
Statement st;
    ...
    private void initComponents() {
        ...
        jPanel1.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 19, 80, -1));
        ...
        jPanel1.add(deposit, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 90, -1));
        ...
        note.setText("जमा करने के लिए राशि दर्ज करें: ");
        ...
        jLabel5.setText("Welcome to Gramin Seva Bank");
...
if(amount>=50000){
    note.setText("राशि 50000 . से अधिक है"); 
    notes1.setText("पुनः प्रयास करने के लिए लॉगआउट करें!!");
    collect.setVisible(false);
}
else if(amount<=50){
    note.setText("राशि बहुत कम जमा करने के लिए");
    notes1.setText("पुनः प्रयास करने के लिए लॉगआउट करें!!");
    collect.setVisible(false);
}
else{
     ...
     if(rs.next()){
         ...
         int temp=balan+amount;
            ...
            int rowsEffected = st.executeUpdate(strSQL);
             if (rowsEffected == 0){
                note.setText("राशि जमा नहीं है ");
                collect.setVisible(false);
            }
            else{
                 note.setText("राशि सफलतापूर्वक जमा कर दी गई है ");
                collect.setVisible(false);
            }
