 ...
 */
public class widthraw_marathi extends javax.swing.JFrame {

    /**
     * Creates new form splash
     */
    public widthraw_marathi() {
        initComponents();
        seticon();
...
Statement st;
    ...
    private void initComponents() {
        ...
        jPanel1.add(back, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, 100, -1));
        ...
        jPanel1.add(deposit, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, 100, -1));
        ...
        jPanel1.add(balance, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 50, 110, 26));
        ...
        jPanel1.add(favourite, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 130, 120, -1));
...
collect.setText("");// TODO add your handling code here:
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
     ...
     if(wid>=170000){
     note1.setText("पुन्हा प्रयत्न करण्यासाठी लॉगआउट करा");
     note.setText("रक्कम सामान्यपेक्षा जास्त आहे");
    collect.setVisible(false);
     }
     else if(wid<=99){
     note1.setText("पुन्हा प्रयत्न करण्यासाठी लॉगआउट करा");
     note.setText("रक्कम खूप कमी आहे");
    collect.setVisible(false);
     }else{
            try{
    ...
    rs = st.executeQuery(query);
     if(rs.next()){
         ...
         if(balan>=wid){
            ...
            if (rowsEffected == 0){
                note.setText("पैसे काढले जात नाहीत");
                collect.setVisible(false);
            }
            else{
                 note.setText("पैसे काढणे रु"+(wid)+" यशस्वी आहे");
                collect.setVisible(false);
            }
  ...
  note.setText("VERSION: 9.1.1.1");
    ...
    private void depositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositActionPerformed
        note1.setText("------------------");
        note.setText("रक्कम प्रविष्ट कराs");
