 ...
 */
public class verify_marathi extends javax.swing.JFrame {

    /**
     * Creates new form splash
     */
    public verify_marathi() {
        initComponents();
        seticon();
    }
...
Statement st;
    ...
    private void initComponents() {
        ...
        jPanel1.add(widthraw, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, 100, -1));
        ...
        note.setText("कृपया आपला पिन प्रविष्ट करा ");
        ...
        jPanel1.add(balance, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 50, 100, 26));
        ...
        jPanel1.add(favourite, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 130, 100, -1));
...
pin.setText("");// TODO add your handling code here:
    ...
    rs = st.executeQuery(query);
     ...
     //loan.setText("LOAN");
     widthraw.setText("पैसे काढणे");
     deposit.setText("रकम जमा करा");
     fnamez=rs.getString("fname");
     note.setText("स्वागत आहे " + rs.getString("fname") +" "+  rs.getString("lname") +"" );
     favourite.setText("*****");
     balance.setText("शिल्लक पैसे");
    //transaction.setText("Transaction");
     ...
     //loan.setEnabled(true);
        ...
        operation=0;
         ...
         pin.setText("");
         note3.setText("असा कोणताही वापरकर्ता नाही!");
         operation=1;
  ...
  note1.setText("सध्या उपलब्ध आहे");
  ...
  note.setText("VERSION: 9.1.1.1");
    ...
    private void depositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositActionPerformed
        deposit_marathi depositer= new deposit_marathi();
    ...
    private void widthrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_widthrawActionPerformed
       widthraw_marathi wed=new widthraw_marathi();
       wed.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(verify_marathi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new verify_marathi().setVisible(true);
            }
        });
    }
