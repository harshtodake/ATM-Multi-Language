 ...
 */
public class widthraw_hindi extends javax.swing.JFrame {

    /**
     * Creates new form splash
     */
    public widthraw_hindi() {
        initComponents();
        seticon();
...
Statement st;
    ...
    private void initComponents() {
        ...
        jPanel1.add(balance, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 50, 67, 26));
        ...
        jPanel1.add(favourite, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 140, -1, -1));
...
collect.setText("");// TODO add your handling code here:
    ...
    private void enterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterActionPerformed
     ...
     if(wid>=170000){
     note1.setText("पुन: प्रयास करने के लिए लॉगआउट करें");
     note.setText("राशि मानदंड से अधिक है");
    collect.setVisible(false);
     }
     else if(wid<=99){
     note1.setText("पुन: प्रयास करने के लिए लॉगआउट करें");
     note.setText("रकम बहुत कम है");
    collect.setVisible(false);
     }else{
            try{
    ...
    rs = st.executeQuery(query);
     if(rs.next()){
         ...
         if(balan>=wid){
            ...
            if (rowsEffected == 0){
                note.setText("कोई धन निकासी नहीं हुई");
                collect.setVisible(false);
            }
            else{
                 note.setText("आपने सफलतापूर्वक रुपये" +(wid)+" निकाल लिए हैं");
                collect.setVisible(false);
            }
         ...
         else{note.setText("अपर्याप्त शेषराशि");}
  ...
  note.setText("VERSION: 9.1.1.1");
        ...
        balancz=balancz+depo;
         String update="UPDATE customer set balance= +"+(balancz);
            try {
                ...
                Logger.getLogger(deposit_hindi.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        ...
        verify_hindi ver=new verify_hindi();
        this.dispose();
        ver.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(deposit_hindi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new deposit_hindi().setVisible(true);
