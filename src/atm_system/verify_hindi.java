 ...
 */
public class verify_hindi extends javax.swing.JFrame {
...
Statement st;
    ...
    private void initComponents() {
        ...
        jPanel1.add(widthraw, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 48, 120, -1));
        ...
        jPanel1.add(deposit, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 129, 120, -1));
        ...
        note.setText("कृपया अपना पिन दर्ज करें ");
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 40, -1, -1));
        ...
        jPanel1.add(balance, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 50, 100, 26));
        ...
        jPanel1.add(favourite, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 140, 90, -1));

        jPanel9.setBackground(new java.awt.Color(255, 255, 0));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel2.setText("Welcome to Gramin Seva Bank");
   ...
   note1.setText("यह सुविधा");
   note.setText("उपलब्ध नहीं है!!!");
...
pin.setText("");// TODO add your handling code here:
    ...
    rs = st.executeQuery(query);
     ...
     //loan.setText("LOAN");
     widthraw.setText("पैसा निकालना");
     deposit.setText("पैसे जमा करो");
     fnamez=rs.getString("fname");
     note.setText("स्वागत हे, " + rs.getString("fname") +" "+  rs.getString("lname") +"" );
     favourite.setText("*****");
     balance.setText("बैंक बैलेंस चेक करें");
    // transaction.setText("Transaction");
     ...
     //loan.setEnabled(true);
        ...
        operation=0;
         ...
         pin.setText("");
         note3.setText("ऐसा कोई उपयोगकर्ता नहीं है");
         operation=1;
  ...
  note1.setText("अभी उपलब्ध है");
  note.setText("शेषराशि: रुपये "+balancz);
  ...
  note.setText("VERSION: 9.1.1.1");
    ...
    private void depositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_depositActionPerformed
        deposit_hindi depositer= new deposit_hindi();
    ...
    private void widthrawActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_widthrawActionPerformed
       widthraw_hindi wed=new widthraw_hindi();
       wed.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(verify_hindi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new verify_hindi().setVisible(true);
            }
        });
    }
